...
trainButton.addEventListener("click",  function() {trainModel(trainingUrl, testingUrl);});
testButton = document.querySelector('#testButton');
testButton.addEventListener("click", function() {testModel(testVal);});

async function trainModel(trainingUrl, testingUrl) {
  // const trainingUrl = 'wdbc-train.csv';
...
async function testModel(testVal) {
